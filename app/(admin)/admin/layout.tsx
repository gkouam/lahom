...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Escape closes; Tab cycles focus inside the sheet while open.
  useEffect(() => {
    if (!moreOpen) return
    ...
    <div className="admin-layout">
      ...
      {moreOpen && (
        <div className="admin-more-overlay" onClick={() => setMoreOpen(false)}>
          ...
          >
            <div className="kente-bar" style={{ height: '3px', borderRadius: '16px 16px 0 0' }} />
            <div className="admin-more-rows">
              {can('MANAGE_MEETINGS') && (
                <Link href="/admin/meetings" className="admin-more-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                    <polyline points="14 2 14 8 20 8" />
                    <line x1="16" x2="8" y1="13" y2="13" />
              ...
              {can('MANAGE_GALLERY') && (
                <Link href="/admin/gallery" className="admin-more-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
                    <circle cx="8.5" cy="8.5" r="1.5" />
                    <polyline points="21 15 16 10 5 21" />
              ...
              {(isSuper || can('MANAGE_MEMBERS') || can('MANAGE_FINANCES')) && (
                <Link href="/admin/reports" className="admin-more-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21.21 15.89A10 10 0 1 1 8 2.83" />
                    <path d="M22 12A10 10 0 0 0 12 2v10z" />
                  </svg>
              ...
              {can('MANAGE_PERMISSIONS') && (
                <Link href="/admin/permissions" className="admin-more-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                  </svg>
                  {t('admin.permissions')}
              ...
              <Link href="/dashboard" className="admin-more-row">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <rect width="18" height="18" x="3" y="3" rx="2" ry="2" />
                  <path d="M3 9h18" />
                  <path d="M9 21V9" />
              ...
              <button className="admin-more-row" onClick={() => signOut({ callbackUrl: '/' })}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" />
                  <polyline points="16 17 21 12 16 7" />
                  <line x1="21" y1="12" x2="9" y2="12" />
